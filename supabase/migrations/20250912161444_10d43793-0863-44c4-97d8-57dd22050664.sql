-- Business Manager Database Schema for Morocco
...
-- Insérer les taux TVA marocains par défaut
INSERT INTO public.tax_rates (id, user_id, name, rate, effective_date) VALUES
  ('00000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000000', 'TVA 20%', 0.2000, '2024-01-01'),
  ('00000000-0000-0000-0000-000000000002', '00000000-0000-0000-0000-000000000000', 'TVA 14%', 0.1400, '2024-01-01'),
  ('00000000-0000-0000-0000-000000000003', '00000000-0000-0000-0000-000000000000', 'TVA 10%', 0.1000, '2024-01-01'),
  ('00000000-0000-0000-0000-000000000004', '00000000-0000-0000-0000-000000000000', 'TVA 7%', 0.0700, '2024-01-01'),
  ('00000000-0000-0000-0000-000000000005', '00000000-0000-0000-0000-000000000000', 'Exonéré', 0.0000, '2024-01-01')
ON CONFLICT (user_id, name, effective_date) DO NOTHING;